module github.com/giantswarm/crossplane-fn-network-discovery

go 1.22

replace github.com/giantswarm/xfnlib => /home/mproffitt/src/github.com/giantswarm/composition-functions/xfnlib
